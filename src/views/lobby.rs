...
pub fn Lobby() -> Element {
    ...
    rsx! {
        div {
            class: "flex flex-col items-center justify-center space-y-4 p-8 w-full max-w-md mx-auto bg-gray-800 rounded-lg shadow-xl",
            h1 {
            ...
            Link {
                ...
                to: Route::Play { time_limit: Some(*time_limit.read()) },
                "Start"
            }
        }
    }
